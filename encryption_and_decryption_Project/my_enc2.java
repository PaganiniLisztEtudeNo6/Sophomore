...
public class my_enc2 {
    public static void main(String[] args) {
        ...
        try {
             ...
             * b. Construct the appropriate IvParameterSpec object for the data to pass to
             * Cipher's init() method
             */

            final int AES_KEYLENGTH = 128; // change this as desired for the security level you want
            byte[] iv = new byte[AES_KEYLENGTH / 8]; // Save the IV bytes or send it in plaintext with the encrypted
